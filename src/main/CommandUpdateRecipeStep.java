...
public class CommandUpdateRecipeStep extends Command {

    public CommandUpdateRecipeStep(Input in, Output out, Recipe recipe) {
        super(in, out, recipe);
    }
    ...
    public void execute() {
        ...
        super.recipe.getSteps().set(stepNumber, createRecipeStep());
    }
